...
const DriversPage = () => {
    const [addDriverModalIsOpen, setAddDriverModalIsOpen] =
    ...
    const filteredDriversByTeam = () => {
        const selectedTeam = teams.find(
            (team) => team.manufacturer === selectedTeamName
        );
        let filteredDriversByTeam: IDriver[] = [];

        if (selectedTeam) {
            filteredDriversByTeam = drivers.filter(
                (driver) => driver.team === selectedTeamName
            );
        }
