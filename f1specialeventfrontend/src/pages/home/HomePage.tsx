...
const HomePage = () => {
    ...
    return (
        ...
        <div className='d-flex justify-content-center w-100'>
            <Carousel data-bs-theme="dark" style={{width: "900px", height: "300px", justifyContent: "center", alignItems: "center"}}>
                {images.map((image) => (
                    <Carousel.Item style={{justifyContent: "center"}}>
                        <img src={image} alt={`Homepage image carusel item - ${image}`} style={{height: "200px", alignSelf: "center"}}/>
                    </Carousel.Item>
                ))}
            </Carousel>
        </div>
