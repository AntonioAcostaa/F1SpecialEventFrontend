...
const RacesPage = () => {
    ...
    const { races, getAllRaces, addRace, removeRace, updateRace } = useContext(RaceContext) as IRaceContext;
    ...
    return (
        <div className='container'>
            ...
            {deleteRaceModalIsOpen && <DeleteRaceModal isOpen={deleteRaceModalIsOpen} setIsOpen={setDeleteRaceModalIsOpen} removeRace={removeRace} />}
            {updateRaceModalIsOpen && <EditRaceModal isOpen={updateRaceModalIsOpen} setIsOpen={setUpdateRaceModalIsOpen} updateRace={updateRace} />}
        </div>
    );
};
