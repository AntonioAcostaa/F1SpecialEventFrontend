...
const TeamsPage = () => {
    ...
    const { teams, getAllTeams, addTeam, removeTeam, updateTeam } = useContext(
        TeamContext
    ) as ITeamContext;
    ...
    return (
        <div className="container p-5">
            ...
            <button
                ...
                onClick={() => setDeleteTeamModalIsOpen(!deleteTeamModalIsOpen)}
            >
                Delete team
            </button>
            <button
                className="btn btn-danger mx-1"
                onClick={() => setUpdateTeamModalIsOpen(!updateTeamModalIsOpen)}
            >
                Update team
            </button>
